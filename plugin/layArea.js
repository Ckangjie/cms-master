// ========== HTML 引用方法 ==========
// <div class="layui-row layui-col-space15" id="area">
...
//             <div class="layui-input-block">
//                 <input name="address" lay-verify="notempty" lay-verType="tips" placeholder="请输入公司详情地址" autocompvare="off" class="layui-input" type="text">
//             </div>
//         </div>
//     </div>
// </div>
...
// app.layarea.render({
//     elem:'#area',
//     data:{province:result.data.province, city:result.data.city, county:result.data.county}
// });
layui.define(['jquery','form'], function (exports) {
    ...
    Class.prototype.events = function () {
      ...
      form.on('select('+provinceFilter+')', function(data){
        ...
        var code = getCode('province', data.value);
        renderCity(code);
      ...
      form.on('select('+cityFilter+')', function(data){
        ...
        var code = getCode('city', data.value);
        renderCounty(code);
      ...
      function getList(type, code) {
        ...
        var result = [];
        for(var i in list){
            result.push({code:i,name:list[i]});
        }
        ...
        if (code) {
            ...
            // @Author: 魏大毛 [1920660234@qq.com]
            var arr = [];
            $(result).filter(function(i, e){
                if(e.code.indexOf(code) === 0) arr.push(e);
            });
            result = arr;
